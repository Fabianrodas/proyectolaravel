      ...
      <form method="POST" action="{{ route('register.post') }}" enctype="multipart/form-data">
        ...
        <div class="mt-3 text-center">
          <p class="text-muted" style="font-size: 0.85rem;">
            People who use our service may have uploaded your contact information to Mango ©. More information. By
            clicking "Sign up", you agree to our Terms, Privacy Policy and Cookies Policy. We may send you SMS
            notifications, which you can turn off at any time.
          </p>
        </div>
